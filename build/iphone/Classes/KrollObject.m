...
//@interface searchandplayObject : NSObject
//@end

@interface searchandplayObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[searchandplayObject class]])
		{
			for (NSString *key in [[(searchandplayObject*)o modules] allKeys])
			{
