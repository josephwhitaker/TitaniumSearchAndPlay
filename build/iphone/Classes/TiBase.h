...
// in simulator we redefine to format for searchandplay Developer console
...
{\
	NSString * exceptionName = [@"org.searchandplay." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.searchandplay";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIsearchandplayNativeItemNone = -1, 
	UIsearchandplayNativeItemSpinner = -2,
	UIsearchandplayNativeItemProgressBar = -3,
	
	UIsearchandplayNativeItemSlider = -4,
	UIsearchandplayNativeItemSwitch = -5,
	UIsearchandplayNativeItemMultiButton = -6,
	UIsearchandplayNativeItemSegmented = -7,
	
	UIsearchandplayNativeItemTextView = -8,
	UIsearchandplayNativeItemTextField = -9,
	UIsearchandplayNativeItemSearchBar = -10,
	
	UIsearchandplayNativeItemPicker = -11,
	UIsearchandplayNativeItemDatePicker = -12,
	
	UIsearchandplayNativeItemInfoLight = -13,
	UIsearchandplayNativeItemInfoDark = -14,
	
	UIsearchandplayNativeItemDisclosure = -15,
	
	UIsearchandplayNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all searchandplay instances of
