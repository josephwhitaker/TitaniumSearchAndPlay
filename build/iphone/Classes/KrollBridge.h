...
@interface searchandplayObject : KrollCoverageObject {
#else
@interface searchandplayObject : KrollObject {
#endif
@private
...
extern NSString * searchandplay$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	searchandplayObject *_searchandplay;
    KrollObject* console;
	BOOL shutdown;
