...
//Rare exceptions to indicate a bug in the _searchandplay code (Eg, function that a subclass should have implemented)
...
/**
 The base class for searchandplay proxies.
 */
