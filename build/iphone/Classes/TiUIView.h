...
/**
 Base class for all searchandplay views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the searchandplay view hierarchy (such as wrapped iOS UIViews) was touched.
